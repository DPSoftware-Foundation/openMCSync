...
exports.addDPCloudevAccount = async function(username, password) {
    try {
        const response = await axios.post('https://example.com/account/v3/login', {
            username: username,
            password: password
        }, {
            headers: {
        ...
        if (response.data && response.data.session) {
            const responseinfo = await axios.post('https://example.com/account/v3/info', {
...
exports.removeDPCloudevAccount = async function(uuid){
    try {
        ...
        const response = await axios.post('https://example.com/account/v3/logout', {
