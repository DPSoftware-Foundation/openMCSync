    ...
    authKeys.forEach((val) => {
        ...
        if (acc.type != "dpcloudev") {
            skinimage = `<div class="settingsAuthAccountLeft">
                <img class="settingsAuthAccountImage" alt="${acc.displayName}" src=https://cdn.damp11113.xyz/cache/mc_body_img/${acc.uuid}?size=60">
            </div>`
        }
 ...
 */
async function resolveModsForUI(){} // no longer used
